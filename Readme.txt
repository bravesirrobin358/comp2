...
2. From that folder, compile and run TestL3.java:
Under macOS, Linux, or Unix in general:
> javac -cp junit-4.13.jar:hamcrest-core-1.3.jar:. TestL3.java

> java -cp junit-4.13.jar:hamcrest-core-1.3.jar:. TestL3
