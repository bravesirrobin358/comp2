...
public class SinglyLinkedList<E> implements List<E>, Iterable<E> {
    ...
    public int count(E fromElement, E toElement) {
        Node<E> fromNode = head;
        //Find first node with equivalent value
        while(fromNode != tail){
        ...
        //fromElement was not found
        if(fromNode == tail && fromNode.value != fromElement){
            return 0;
        }
        ...
        if (fromElement == toElement){
            ...
            return count(fromNode, toElement, 1);
        }
    }

    private int count(Node<E> fromNode, E toElement, int count){
        if (fromNode.value == toElement || fromNode == tail){
            return count;
        }else{
            return count(fromNode.next, toElement, count+1);
        }
    }
